...
import { checkDifficulty } from '../utils.js';
...
const buttonSelector = document.getElementById('full-game'),
    [blueButton, redButton, yellowButton, greenButton] =
    buttonSelector.querySelectorAll('button'),
...
document.addEventListener('keydown', function(e) {
    if (e.key === 'q') {
        blueButton.click(), blueButton.focus();
    }
});
document.addEventListener('keydown', function(e) {
    if (e.key === 'w') {
        redButton.click(), redButton.focus();
    }
});
document.addEventListener('keydown', function(e) {
    if (e.key === 'a') {
        yellowButton.click(), yellowButton.focus();
    }
});
document.addEventListener('keydown', function(e) {
    if (e.key === 's') {
        greenButton.click(), greenButton.focus();
    }
});
